...
class ReflexAgent(Agent):
    ...
    def evaluationFunction(self, currentGameState, action):
        ...
        # print(f"SucessorGameState: {successorGameState}")
        ...
        if foodList:
            ...
            for food in foodList:
                ...
                if minFoodDistance >= foodDistance:
        ...
        if minGhostDistance <= 4:
            return (1 / float(minFoodDistance)) + successorGameState.getScore() / 2 - float(minGhostDistance)
        return (1 / float(minFoodDistance)) + successorGameState.getScore()
